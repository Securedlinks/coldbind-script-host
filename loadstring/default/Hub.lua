...
local infisButton = createScriptButton(
    "Infinite Script",
    "Special infinite features script",
    UDim2.new(0, 0, 0, 255),
    "https://coldbind-script-host.onrender.com/loadstring/default/infis.txt?key=coldbind_access_2024"
)
...
closeButton.MouseButton1Click:Connect(function()
    ...
    local infisBtnTween = TweenService:Create(infisButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
        BackgroundTransparency = 1
    })
    ...
    for _, child in pairs(infisButton:GetChildren()) do
        if child:IsA("TextLabel") then
            TweenService:Create(child, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                TextTransparency = 1
            }):Play()
